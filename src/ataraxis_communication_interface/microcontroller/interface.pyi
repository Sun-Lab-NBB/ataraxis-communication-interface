...
from .status_codes import (
    ...
    describe_kernel_event as describe_kernel_event,
    describe_module_event as describe_module_event,
    describe_custom_module_error as describe_custom_module_error,
)
...
class ModuleInterface(ABC, metaclass=abc.ABCMeta):
    ...
    _error_codes: dict[np.uint8, str]
...
class MicroControllerInterface:
    ...
    def _parse_kernel_data(
        controller_id: np.uint8, controller_name: str, incoming_data: KernelState | KernelData
    ) -> None: ...
    @staticmethod
    def _parse_service_module_data(
        controller_id: np.uint8, controller_name: str, module_name: str, incoming_data: ModuleState | ModuleData
    ) -> None: ...
    @staticmethod
    def _runtime_cycle(
        controller_id: np.uint8,
